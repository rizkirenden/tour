...
@section('title', 'Perlengkapan - Arrum Tour')
@section('page-title', 'Perlengkapan')
...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
        <span class="text-gray-500 font-medium">Perlengkapan</span>
    </li>
@endsection
        ...
        <div class="p-6">
            <div class="flex gap-3 mb-4">
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="search" placeholder="Cari perlengkapan..."
...
@push('scripts')
    <script>
        function applyFilter() {
            ...
            fetch(`{{ route('master.perlengkapan.index') }}?search=${search}&ajax=true`)
