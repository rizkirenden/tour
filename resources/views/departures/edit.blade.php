                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <!-- Tambahkan setelah Tanggal Kepulangan -->
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                        Bulan Keberangkatan
                                    ...
                                    <select name="bulan_keberangkatan"
                                        ...
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('bulan_keberangkatan', $departure->bulan_keberangkatan) == $i ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tahun_keberangkatan"
                                        value="{{ old('tahun_keberangkatan', $departure->tahun_keberangkatan ?? date('Y')) }}"
                                        class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-sm"
