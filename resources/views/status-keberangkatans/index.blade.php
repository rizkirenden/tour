...
@section('title', 'Status Keberangkatan - Arrum Tour')
@section('page-title', 'Status Keberangkatan')
...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
        <span class="text-gray-500 font-medium">Status Keberangkatan</span>
    </li>
@endsection
...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
            <div>
                <h5 class="text-sm font-semibold text-gray-700">Daftar Status Keberangkatan</h5>
                <p class="text-xs text-gray-400 mt-0.5">Kelola semua status keberangkatan</p>
            </div>
            <a href="{{ route('master.status-keberangkatan.create') }}"
        ...
        <div class="p-6">
            <div class="flex gap-3 mb-4">
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="search" placeholder="Cari status..."
            ...
            <div id="table-container">
                @include('status-keberangkatans.table')
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    <script>
        function applyFilter() {
            ...
            fetch(`{{ route('master.status-keberangkatan.index') }}?search=${search}&ajax=true`)
