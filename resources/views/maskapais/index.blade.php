...
@section('title', 'Maskapai - Arrum Tour')
...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
        <span class="text-gray-500 font-medium">Maskapai</span>
    </li>
@endsection
        ...
        <div class="p-6">
            <div class="flex gap-3 mb-4">
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="search" placeholder="Cari maskapai..."
