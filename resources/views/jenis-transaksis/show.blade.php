...
@section('title', 'Detail Jenis Transaksi - Arrum Tour')
@section('page-title', 'Detail Jenis Transaksi')
    ...
    <div class="mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex flex-wrap items-center justify-between gap-3">
                <div>
                    <h5 class="text-sm font-semibold text-gray-700">Detail Jenis Transaksi</h5>
                    <p class="text-xs text-gray-400 mt-0.5">Informasi lengkap jenis transaksi</p>
                </div>
                <div class="flex items-center gap-2">
                    <a href="{{ route('master.jenis-transaksi.edit', $jenis->id_jenis) }}"
            ...
            <div class="p-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <dl class="space-y-3">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <dd class="font-medium text-gray-700">{{ $jenis->keterangan ?? '-' }}</dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <dl class="space-y-3">
                            <div class="flex justify-between text-sm">
                                ...
                                <dd class="font-medium text-gray-700">{{ $jenis->created_at->format('d/m/Y H:i') }}</dd>
                            </div>
                            <div class="flex justify-between text-sm">
                                <dt class="text-gray-500">Terakhir diupdate</dt>
                                <dd class="font-medium text-gray-700">{{ $jenis->updated_at->format('d/m/Y H:i') }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-100 flex flex-wrap items-center justify-end gap-3">
                    ...
                    <a href="{{ route('master.jenis-transaksi.edit', $jenis->id_jenis) }}"
                        class="inline-flex items-center px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition text-sm font-medium shadow-sm hover:shadow">
                        <i class="fas fa-edit mr-2"></i> Edit Jenis
                    </a>
                </div>
            </div>
        </div>
