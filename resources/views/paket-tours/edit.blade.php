...
@section('title', 'Edit Paket Umroh Plus - Arrum Tour')
@section('page-title', 'Edit Paket Umroh Plus')
    ...
    <div class="mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
                <h5 class="text-sm font-semibold text-gray-700">Form Edit Paket Umroh Plus</h5>
                <p class="text-xs text-gray-400 mt-0.5">Edit data paket umroh plus</p>
            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="3"
                            class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-sm"
                            placeholder="Deskripsikan paket umroh plus ini...">{{ old('deskripsi', $paketTour->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
