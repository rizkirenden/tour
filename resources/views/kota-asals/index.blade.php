...
@section('title', 'Kota Asal - Arrum Tour')
@section('page-title', 'Kota Asal')
...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
            <div>
                <h5 class="text-sm font-semibold text-gray-700">Daftar Kota Asal</h5>
                <p class="text-xs text-gray-400 mt-0.5">Kelola semua kota asal keberangkatan</p>
            </div>
            <a href="{{ route('master.kota-asal.create') }}"
        ...
        <div class="p-6">
            <div class="flex gap-3 mb-4">
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="search" placeholder="Cari kota asal..."
...
@push('scripts')
    <script>
        function applyFilter() {
            ...
            fetch(`{{ route('master.kota-asal.index') }}?search=${search}&ajax=true`)
