...
@section('title', 'Data Keluarga / Kelompok - Arrum Tour')
@section('page-title', 'Data Keluarga / Kelompok')
...
@section('breadcrumb')
    ...
    <li class="inline-flex items-center">
        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
        <span class="text-gray-500 font-medium">Keluarga / Kelompok</span>
    </li>
@endsection
...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
            <div>
                <h5 class="text-sm font-semibold text-gray-700">Daftar Keluarga / Kelompok</h5>
                <p class="text-xs text-gray-400 mt-0.5">Kelola semua data keluarga / kelompok</p>
            </div>
            <div class="flex items-center gap-3">
                <span class="text-xs text-gray-500">
                    Total: <span class="font-medium text-gray-700">{{ $data->total() }}</span> keluarga / kelompok
                </span>
                <a href="{{ route('transaksional.keluarga.create') }}"
                    ...
                    <i class="fas fa-plus mr-2"></i> Tambah Keluarga / Kelompok
                </a>
            </div>
        </div>
            ...
            <form method="GET" action="{{ route('transaksional.keluarga.index') }}" id="filterForm" class="mb-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div class="relative">
                        ...
                        <input type="text" name="search" id="search" placeholder="Cari keluarga / kelompok..."
