    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Kelola semua metode pembayaran</p>
            </div>
        ...
        <div class="p-6">
            <div class="flex gap-3 mb-4">
                <div class="relative flex-1 max-w-xs">
                    ...
                    <input type="text" id="search" placeholder="Cari bank, rekening, atau atas nama..."
...
@push('scripts')
    <script>
        function applyFilter() {
            ...
            fetch(`{{ route('master.metode-pembayaran.index') }}?search=${search}&ajax=true`)
