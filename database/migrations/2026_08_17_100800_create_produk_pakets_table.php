...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('produk_pakets', function (Blueprint $table) {
            ...
            $table->integer('total_harga')->default(0)->comment('Total harga dari harga bulanan');
            ...
            $table->integer('durasi_tour')->default(0)->comment('Durasi dari paket tour');
            $table->integer('durasi_hari')->nullable()->comment('Total durasi dalam hari');
